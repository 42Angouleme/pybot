...
def initialiser_boutons():
    ...
    boutons.capture = robot.fenetre.creer_bouton(
        180, 60, 10, 80, Couleur.ROUGE)
    ...
    boutons.filter_1 = robot.fenetre.creer_bouton(
        200, 60, 15, 220, Couleur.ORANGE)
    boutons.filter_1.ajouter_texte("filtre: ocean", 10, 10, 16)
    boutons.filter_2 = robot.fenetre.creer_bouton(
        200, 60, 15, 290, Couleur.ORANGE)
    boutons.filter_2.ajouter_texte("filtre: cartoon", 10, 10, 16)
    boutons.filter_3 = robot.fenetre.creer_bouton(
        200, 60, 15, 360, Couleur.ORANGE)
    boutons.filter_3.ajouter_texte("filtre: alien", 10, 10, 16)
    boutons.filter_4 = robot.fenetre.creer_bouton(
        200, 60, 15, 430, Couleur.ORANGE)
    boutons.filter_4.ajouter_texte("filtre: rose", 10, 10, 16)
    boutons.filter_5 = robot.fenetre.creer_bouton(
        200, 60, 15, 500, Couleur.ORANGE)
    boutons.filter_5.ajouter_texte("filtre: flou", 10, 10, 16)
    boutons.filter_6 = robot.fenetre.creer_bouton(
        200, 60, 15, 570, Couleur.ORANGE)
    boutons.filter_6.ajouter_texte("filtre: noir et blanc", 10, 10, 16)
    boutons.filter_7 = robot.fenetre.creer_bouton(
        200, 60, 15, 640, Couleur.ORANGE)
    boutons.filter_7.ajouter_texte("filtre: tourner", 10, 10, 16)
    boutons.filter_8 = robot.fenetre.creer_bouton(
        200, 60, 15, 710, Couleur.ORANGE)
    boutons.filter_8.ajouter_texte("filtre: vernis", 10, 10, 16)
    boutons.stop = robot.fenetre.creer_bouton(
        180, 60, 10, 900, Couleur.VERT_SAPIN)
