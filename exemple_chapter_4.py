...
def boucle_boutons():
    ...
    if boutons.filter_1.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "ocean")
        robot.attributs.mettre_a_jour_affichage = True
    if boutons.filter_2.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "cartoon")
        robot.attributs.mettre_a_jour_affichage = True
    if boutons.filter_3.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "alien")
        robot.attributs.mettre_a_jour_affichage = True
    if boutons.filter_4.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "rose")
        robot.attributs.mettre_a_jour_affichage = True
    if boutons.filter_5.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "flou")
        robot.attributs.mettre_a_jour_affichage = True
    if boutons.filter_6.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "noir_et_blanc")
        robot.attributs.mettre_a_jour_affichage = True
    if boutons.filter_7.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "tourner")
        robot.attributs.mettre_a_jour_affichage = True
    if boutons.filter_8.est_actif():
        robot.camera.appliquer_filtre_a("/images/photo.jpg", "vernis")
        robot.attributs.mettre_a_jour_affichage = True
# ----------------------------------------
