...
def initialisation_boutons():
    ...
    boutons.camera = robot.creer_bouton(180, 60, 10, 10, Couleur.BLEU)
    boutons.camera.ajouter_texte("camera - allumer", 5, 20)
    boutons.capture = robot.creer_bouton(180, 60, 10, 80, Couleur.ROUGE)
    boutons.capture.ajouter_texte("capture photo", 10, 10, 20)
    boutons.photo = robot.creer_bouton(180, 60, 10, 150, Couleur.JAUNE)
    boutons.photo.ajouter_texte("afficher photo", 10, 10, 16)
    boutons.filter_1 = robot.creer_bouton(200, 60, 15, 220, Couleur.ORANGE)
    boutons.filter_1.ajouter_texte("filtre: ocean", 10, 10, 16)
    boutons.filter_2 = robot.creer_bouton(200, 60, 15, 290, Couleur.ORANGE)
    boutons.filter_2.ajouter_texte("filtre: cartoon", 10, 10, 16)
    boutons.filter_3 = robot.creer_bouton(200, 60, 15, 360, Couleur.ORANGE)
    boutons.filter_3.ajouter_texte("filtre: alien", 10, 10, 16)
    boutons.filter_4 = robot.creer_bouton(200, 60, 15, 430, Couleur.ORANGE)
    boutons.filter_4.ajouter_texte("filtre: rose", 10, 10, 16)
    boutons.filter_5 = robot.creer_bouton(200, 60, 15, 500, Couleur.ORANGE)
    boutons.filter_5.ajouter_texte("filtre: flou", 10, 10, 16)
    boutons.filter_6 = robot.creer_bouton(200, 60, 15, 570, Couleur.ORANGE)
    boutons.filter_6.ajouter_texte("filtre: noir et blanc", 10, 10, 16)
    boutons.filter_7 = robot.creer_bouton(200, 60, 15, 640, Couleur.ORANGE)
    boutons.filter_7.ajouter_texte("filtre: tourner", 10, 10, 16)
    boutons.filter_8 = robot.creer_bouton(200, 60, 15, 710, Couleur.ORANGE)
    boutons.filter_8.ajouter_texte("filtre: vernis", 10, 10, 16)
    boutons.stop = robot.creer_bouton(180, 60, 10, 900, Couleur.VERT_SAPIN)
