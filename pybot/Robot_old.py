...
class Robot_old:
    ...
    def creer_fenetre(self, longueur: int = 800, hauteur: int = 600): # Decouper entre Camera etr fenetre et renommer ouveirfenetre 
        '''
        ...
        try:
            ...
            self.message_erreur("L'application web doit être lancée avant de créer la fenêtre.", "fr")
    ...
    def fermer_fenetre(self): # Changer nom par desactiver
        '''
    ...
    def creer_bouton(self, longueur: int, hauteur: int, position_x: int, position_y: int, couleur: Couleur) -> Button: # A deplacer
        """
    ...
    def appliquer_filtre(self, chemin_fichier: str, nom_filtre: str): # Deplacer dans camera
        r"""
    ...
    def ecrire(self, text_area): # Zone de texte | Fenetre
        """
