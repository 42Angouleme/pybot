...
def run():
    ...
    layout = [[sg.Text('Connect to camera...................................')],
              [sg.Button('Connect user'), sg.Button('Bye')]]

    # Create the Window
    window = sg.Window('Robot Python Interface', layout)
    # Event Loop to process "events" and get the "values" of the inputs
    while True:
        event, values = window.read()
        if event == sg.WIN_CLOSED or event == 'Bye':  # if user closes window or clicks cancel
            break
